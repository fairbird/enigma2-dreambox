...
class PluginBrowserNew(Screen):
	...
	def __init__(self, session):
		...
		self.current = 0
		self.current_page = 0
		if config.usage.plugin_style.value == "grid1":
		...
		elif config.usage.plugin_style.value == "grid2":
			self.backgroundPixmap = ""
			...
			self.secondaryColorLabel = "#00000000"
		elif config.usage.plugin_style.value == "grid3":
			self.backgroundPixmap = ""
			self.backgroundColor = "#44000000"
			self.foregroundColor = "#000080ff"
			...
			self.secondaryColorLabel = "#00000000"
		elif config.usage.plugin_style.value == "grid4":
			if isFullHD():
		...
		elif config.usage.plugin_style.value == "grid5":
			if isFullHD():
			...
			self.secondaryColor = "#1b3c85"
			self.secondaryColorLabel = "#00ffc000"
		elif config.usage.plugin_style.value == "grid6":
			if isFullHD():
...
if config.usage.plugin_style.value == "grid1" or config.usage.plugin_style.value == "grid2" or config.usage.plugin_style.value == "grid3" or config.usage.plugin_style.value == "grid4" or config.usage.plugin_style.value == "grid5" or config.usage.plugin_style.value == "grid6":
