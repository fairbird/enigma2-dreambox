...
from skin import fonts, parameters, loadSkin
from Components.ActionMap import HelpableNumberActionMap
from Components.Input import Input
from Components.Label import Label
from Components.Language import language
from Components.MenuList import MenuList
from Components.MultiContent import MultiContentEntryText, MultiContentEntryRectangle, MultiContentEntryPixmapAlphaTest
...
# <!-- This for new style only -->
# <!-- HD Skin -->
vkeyboard_hdskin = '''<screen name="vkeyboard_hdskin" title="Virtual keyboard" position="center,center" size="1020,550" zPosition="99" backgroundColor="#16000000">
		<ePixmap pixmap="/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsHD/key_info.png" position="250,10" size="103,35" zPosition="10" transparent="1" alphatest="blend"/>
		<ePixmap pixmap="/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsHD/key_text.png" position="360,10" size="103,35" zPosition="10" transparent="1" alphatest="blend"/>
		<ePixmap pixmap="/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsHD/key_exit.png" position="470,10" size="103,35" zPosition="10" transparent="1" alphatest="blend"/>
		<ePixmap position="580,10" size="103,38" zPosition="2" pixmap="/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsHD/key_board.png" transparent="1" alphatest="blend"/>
		<widget name="header" conditional="header" position="0,65" size="710,35" font="Regular;30" foregroundColor="#00ffff00" halign="center" transparent="1" noWrap="1"/>
...
vkeyboard_fhdskin = '''<screen name="vkeyboard_fhdskin" title="Virtual keyboard" position="center,center" size="1320,740" zPosition="99" backgroundColor="#16000000">
		<widget name="header" conditional="header" position="133,52" size="990,45" font="Regular;36" foregroundColor="#00ffff00" halign="center" transparent="1" noWrap="1"/>
...
class VirtualKeyBoard(Screen):
	def __init__(self, session, title=_("Virtual KeyBoard Text:"), text="", maxSize=False, visible_width=False, type=Input.TEXT, currPos=None, allMarked=False, style=VKB_ENTER_ICON, windowTitle=None):
		...
		self.bg_r = loadKeyPixmap(path=resolveFilename(SCOPE_CURRENT_SKIN, "buttons/vkey_bg_r.png"))
		self.sel_l = loadKeyPixmap(path=resolveFilename(SCOPE_CURRENT_SKIN, "buttons/vkey_sel_l.png"))
		self.sel_m = loadKeyPixmap(path=resolveFilename(SCOPE_CURRENT_SKIN, "buttons/vkey_sel_m.png"))
		self.sel_r = loadKeyPixmap(path=resolveFilename(SCOPE_CURRENT_SKIN, "buttons/vkey_sel_r.png"))
		key_red_l = loadKeyPixmap(path=resolveFilename(SCOPE_CURRENT_SKIN, "buttons/vkey_red_l.png"))
		key_red_m = loadKeyPixmap(path=resolveFilename(SCOPE_CURRENT_SKIN, "buttons/vkey_red_m.png"))
		key_red_r = loadKeyPixmap(path=resolveFilename(SCOPE_CURRENT_SKIN, "buttons/vkey_red_r.png"))
		key_green_l = loadKeyPixmap(path=resolveFilename(SCOPE_CURRENT_SKIN, "buttons/vkey_green_l.png"))
		key_green_m = loadKeyPixmap(path=resolveFilename(SCOPE_CURRENT_SKIN, "buttons/vkey_green_m.png"))
		key_green_r = loadKeyPixmap(path=resolveFilename(SCOPE_CURRENT_SKIN, "buttons/vkey_green_r.png"))
		key_yellow_l = loadKeyPixmap(path=resolveFilename(SCOPE_CURRENT_SKIN, "buttons/vkey_yellow_l.png"))
		key_yellow_m = loadKeyPixmap(path=resolveFilename(SCOPE_CURRENT_SKIN, "buttons/vkey_yellow_m.png"))
		key_yellow_r = loadKeyPixmap(path=resolveFilename(SCOPE_CURRENT_SKIN, "buttons/vkey_yellow_r.png"))
		key_blue_l = loadKeyPixmap(path=resolveFilename(SCOPE_CURRENT_SKIN, "buttons/vkey_blue_l.png"))
		key_blue_m = loadKeyPixmap(path=resolveFilename(SCOPE_CURRENT_SKIN, "buttons/vkey_blue_m.png"))
		key_blue_r = loadKeyPixmap(path=resolveFilename(SCOPE_CURRENT_SKIN, "buttons/vkey_blue_r.png"))
		key_backspace = loadKeyPixmap(path=resolveFilename(SCOPE_CURRENT_SKIN, "buttons/vkey_backspace.png"))
		key_clear = loadKeyPixmap(path=resolveFilename(SCOPE_CURRENT_SKIN, "buttons/vkey_clear.png"))
		key_delete = loadKeyPixmap(path=resolveFilename(SCOPE_CURRENT_SKIN, "buttons/vkey_delete.png"))
		key_enter = loadKeyPixmap(path=resolveFilename(SCOPE_CURRENT_SKIN, "buttons/vkey_enter.png"))
		key_exit = loadKeyPixmap(path=resolveFilename(SCOPE_CURRENT_SKIN, "buttons/vkey_exit.png"))
		key_first = loadKeyPixmap(path=resolveFilename(SCOPE_CURRENT_SKIN, "buttons/vkey_first.png"))
		key_last = loadKeyPixmap(path=resolveFilename(SCOPE_CURRENT_SKIN, "buttons/vkey_last.png"))
		key_left = loadKeyPixmap(path=resolveFilename(SCOPE_CURRENT_SKIN, "buttons/vkey_left.png"))
		key_locale = loadKeyPixmap(path=resolveFilename(SCOPE_CURRENT_SKIN, "buttons/vkey_locale.png"))
		key_right = loadKeyPixmap(path=resolveFilename(SCOPE_CURRENT_SKIN, "buttons/vkey_right.png"))
		key_shift = loadKeyPixmap(path=resolveFilename(SCOPE_CURRENT_SKIN, "buttons/vkey_shift.png"))
		key_shift0 = loadKeyPixmap(path=resolveFilename(SCOPE_CURRENT_SKIN, "buttons/vkey_shift0.png"))
		key_shift1 = loadKeyPixmap(path=resolveFilename(SCOPE_CURRENT_SKIN, "buttons/vkey_shift1.png"))
		key_shift2 = loadKeyPixmap(path=resolveFilename(SCOPE_CURRENT_SKIN, "buttons/vkey_shift2.png"))
		key_shift3 = loadKeyPixmap(path=resolveFilename(SCOPE_CURRENT_SKIN, "buttons/vkey_shift3.png"))
		key_space = loadKeyPixmap(path=resolveFilename(SCOPE_CURRENT_SKIN, "buttons/vkey_space.png"))
		key_space_alt = loadKeyPixmap(path=resolveFilename(SCOPE_CURRENT_SKIN, "buttons/vkey_space_alt.png"))
		...
		if self.nativeKeys or self.bg_l is None or self.bg_m is None or self.bg_r is None:
			self.width = width
			self.height = height
		else:
...
class VirtualKeyBoardstyle(Screen):
	def __init__(self, session, title=_("Virtual KeyBoard Text:"), text="", maxSize=False, visible_width=False, type=Input.TEXT, currPos=None, allMarked=False, style=VKB_ENTER_ICON, windowTitle=None):
		...
		if isHD():
			self.skin = vkeyboard_hdskin
			self.bg = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsHD/vkey_bg.png")
			self.bg_l = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsHD/vkey_bg_l.png")
			self.bg_m = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsHD/vkey_bg_m.png")
			self.bg_r = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsHD/vkey_bg_r.png")
			self.sel_l = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsHD/vkey_sel_l.png")
			self.sel_m = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsHD/vkey_sel_m.png")
			self.sel_r = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsHD/vkey_sel_r.png")
			key_red_l = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsHD/vkey_red_l.png")
			key_red_m = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsHD/vkey_red_m.png")
			key_red_r = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsHD/vkey_red_r.png")
			key_green_l = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsHD/vkey_green_l.png")
			key_green_m = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsHD/vkey_green_m.png")
			key_green_r = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsHD/vkey_green_r.png")
			key_yellow_l = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsHD/vkey_yellow_l.png")
			key_yellow_m = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsHD/vkey_yellow_m.png")
			key_yellow_r = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsHD/vkey_yellow_r.png")
			key_blue_l = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsHD/vkey_blue_l.png")
			key_blue_m = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsHD/vkey_blue_m.png")
			key_blue_r = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsHD/vkey_blue_r.png")
			key_backspace = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsHD/vkey_backspace.png")
			key_clear = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsHD/vkey_clear.png")
			key_delete = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsHD/vkey_delete.png")
			key_enter = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsHD/vkey_enter.png")
			key_exit = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsHD/vkey_exit.png")
			key_first = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsHD/vkey_first.png")
			key_last = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsHD/vkey_last.png")
			key_left = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsHD/vkey_left.png")
			key_locale = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsHD/vkey_locale.png")
			key_right = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsHD/vkey_right.png")
			key_shift = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsHD/vkey_shift.png")
			key_shift0 = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsHD/vkey_shift0.png")
			key_shift1 = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsHD/vkey_shift1.png")
			key_shift2 = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsHD/vkey_shift2.png")
			key_shift3 = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsHD/vkey_shift3.png")
			key_space = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsHD/vkey_space.png")
			key_space_alt = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsHD/vkey_space_alt.png")
		else:
			self.skin = vkeyboard_fhdskin
			self.bg = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsFHD/vkey_bg.png")
			self.bg_l = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsFHD/vkey_bg_l.png")
			self.bg_m = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsFHD/vkey_bg_m.png")
			self.bg_r = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsFHD/vkey_bg_r.png")
			self.sel_l = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsFHD/vkey_sel_l.png")
			self.sel_m = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsFHD/vkey_sel_m.png")
			self.sel_r = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsFHD/vkey_sel_r.png")
			key_red_l = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsFHD/vkey_red_l.png")
			key_red_m = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsFHD/vkey_red_m.png")
			key_red_r = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsFHD/vkey_red_r.png")
			key_green_l = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsFHD/vkey_green_l.png")
			key_green_m = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsFHD/vkey_green_m.png")
			key_green_r = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsFHD/vkey_green_r.png")
			key_yellow_l = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsFHD/vkey_yellow_l.png")
			key_yellow_m = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsFHD/vkey_yellow_m.png")
			key_yellow_r = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsFHD/vkey_yellow_r.png")
			key_blue_l = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsFHD/vkey_blue_l.png")
			key_blue_m = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsFHD/vkey_blue_m.png")
			key_blue_r = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsFHD/vkey_blue_r.png")
			key_backspace = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsFHD/vkey_backspace.png")
			key_clear = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsFHD/vkey_clear.png")
			key_delete = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsFHD/vkey_delete.png")
			key_enter = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsFHD/vkey_enter.png")
			key_exit = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsFHD/vkey_exit.png")
			key_first = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsFHD/vkey_first.png")
			key_last = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsFHD/vkey_last.png")
			key_left = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsFHD/vkey_left.png")
			key_locale = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsFHD/vkey_locale.png")
			key_right = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsFHD/vkey_right.png")
			key_shift = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsFHD/vkey_shift.png")
			key_shift0 = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsFHD/vkey_shift0.png")
			key_shift1 = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsFHD/vkey_shift1.png")
			key_shift2 = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsFHD/vkey_shift2.png")
			key_shift3 = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsFHD/vkey_shift3.png")
			key_space = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsFHD/vkey_space.png")
			key_space_alt = loadKeyPixmap("/usr/share/enigma2/VirtualKeyBoard_Icons/buttonsFHD/vkey_space_alt.png")
		self.keyHighlights = {  # This is a table of cell highlight components (left, middle and right)
			"EXIT": (key_red_l, key_red_m, key_red_r),
			"EXITICON": (key_red_l, key_red_m, key_red_r),
			"DONE": (key_green_l, key_green_m, key_green_r),
